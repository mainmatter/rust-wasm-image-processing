...
> We have create a **full** free Rust course: **["100 Exercises To Learn Rust"](https://rust-exercises.com/100-exercises/)** that teaches Rust from the ground up and covers everything you need to know!

### Exercises

You can find other exercises to practice Rust in the [`rustlings`](https://github.com/rust-lang/rustlings)
...
We offer several masterclasses on key topics hat cut across domains.\
For testing, check out ["Advanced testing, going beyond the basics"](https://rust-exercises.com/advanced-testing/).\
